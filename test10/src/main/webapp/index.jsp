...
<c:set var="user" value="${sessionScope.user}"/>
		...
		<header class="header_section">
			<div class="container">
				<nav class="navbar navbar-expand-lg custom_nav-container ">
					<a class="navbar-brand" href="index"><img alt="logo" style="width: 120px" src="images/logo.png">
					</a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<a href="?lang_local=vi_VN" class="lang">VN
							...
							<a href="?lang_local=en_US" class="lang"> EN
							</a>
						</div>
							...
							<div class="row">
								<div class="col-md-7 col-lg-6 ">
									<div class="detail-box">
										<h1><fmt:message>hello</fmt:message></h1>
										<h2><fmt:message>slogan</fmt:message></h2>
										<div class="btn-box">
				...
				<div class="row">
					<div class="col-md-6  ">
						<div class="box ">
							...
							<div class="detail-box">
								<h5> <fmt:message>chickenjoy</fmt:message></h5>
								<br>
								<a href="menu"> <fmt:message>menu.oder</fmt:message></a>
							</div>
						</div>
					</div>
					<div class="col-md-6  ">
						<div class="box ">
							...
							<div class="detail-box">
								<h5> <fmt:message>burger</fmt:message></h5>
								<br>
								<a href="menu">  <fmt:message>menu.oder</fmt:message> </a>
							</div>
						</div>
					...
					<div class="col-md-6  ">
						<div class="box ">
							...
							<div class="detail-box">
								<h5> <fmt:message>spicynoodles</fmt:message></h5>
								<br>
								<a href="menu"> <fmt:message>menu.oder</fmt:message> </a>
							</div>
						</div>
					...
					<div class="col-md-6  ">
						<div class="box ">
							...
							<div class="detail-box">
								<h5> <fmt:message>drinks</fmt:message></h5>
								<br>
								<a href="menu">  <fmt:message>menu.oder</fmt:message></a>
							</div>
						</div>
				...
				<div class="col-md-6">
					<div class="detail-box">
						<div class="heading_container">
							<h2><fmt:message>home.mr</fmt:message></h2>
						</div>
						<p><fmt:message>home.content</fmt:message></p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="book_section layout_padding">
		<div class="container">
			<div class="heading_container">
				<h2><fmt:message>menu.contact</fmt:message></h2>
			</div>
			<div class="row">
				<div class="col-md-6">
